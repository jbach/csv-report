...
module.exports = function(main){
	...
	// parses a string and returns seconds ('1:35:30' -> 5730) (todo: more robust?)
	...
	var processEntries = function(data, count) {
		...
		_.each(data, function(entries, projectName, list){
			...
			list[projectName] = _.map(entries, function(dayEntries, dayGroup){
				...
				dayEntries.duration = (Math.ceil(dayEntries.duration / (main.options.round * 60)) * main.options.round * 60);
